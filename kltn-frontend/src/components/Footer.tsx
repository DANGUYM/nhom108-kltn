          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="md:w-1/2 text-center md:text-left">
              ...
              <p className="text-gray-600">
                Nhận thông báo về thời trang mới và ưu đãi đặc biệt hàng tuần!
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-gray-600 mb-6">
              DAVINCI - Thương hiệu thời trang cao cấp với bộ sưu tập đa dạng và
              phong cách hiện đại. Khám phá không gian thời trang và tìm kiếm
              những món đồ phù hợp với phong cách của bạn.
            </p>
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="bg-blue-400 text-white p-2 rounded-full hover:bg-blue-500 transition duration-200"
              >
                <FaTwitter size={16} />
              </a>
            </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  to="/products?hasDiscount=true&sort=currentDiscountPercent,DESC"
                  className="text-gray-600 hover:text-red-600 transition duration-200"
                >
                  Flash sale
                </Link>
        ...
        <div className="container mx-auto px-4 lg:max-w-7xl flex flex-col md:flex-row items-center justify-between">
          <div className="mb-4 md:mb-0">
            <p className="text-sm text-gray-600">
              © {new Date().getFullYear()} DAVINCI - Thương hiệu thời trang cao
              cấp. Tất cả quyền được bảo lưu.
            </p>
          </div>
          <div className="flex items-center">
            <img
              src="https://cdn0.fahasa.com/media/wysiwyg/payment-footer.png"
              alt="Payment Methods"
              className="h-6"
            />
          </div>
