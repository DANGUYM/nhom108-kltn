...
@Tag(name = "Discount Management", description = "APIs for managing discounts and product discounts")
public class DiscountController {
    ...
    @Operation(
        ...
        description = "Delete a discount by ID. Cannot delete if discount is being used. Requires ADMIN role.",
        security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @Operation(
        ...
        description = "Retrieve discount details by ID"
    )
    ...
    public APIResponse<List<DiscountResponse>> getExpiringSoonDiscounts(
            @Parameter(description = "Days ahead to check for expiration") @RequestParam(defaultValue = "7") int daysAhead) {
    ...
    public APIResponse<Page<DiscountResponse>> getDiscountsByDateRange(
        ...
        Page<DiscountResponse> response = discountService.getDiscountsByDateRange(startDate, endDate, pageable);
    ...
    @Operation(
        ...
        description = "Find discount by exact name"
    )
    ...
    public APIResponse<Void> applyDiscountToProducts(
        ...
        return APIResponse.<Void>builder()
                .message("Áp dụng discount cho sản phẩm thành công")
                .build();
    }
    ...
    public APIResponse<Void> removeDiscountFromProducts(
        ...
        return APIResponse.<Void>builder()
                .message("Gỡ bỏ discount khỏi sản phẩm thành công")
                .build();
    }
